...
def read_image_list_subclass(im_dir, n_max=None, n_repeat=None):
    items = []
...
def load_mnist(dataset_dir, split="train"):
    ...
    #n_max = 100 if split == "train" else 10000
    if split == "train":
        n_max = 10240
        # n_max = 50
        # return read_image_list_subclass(data_dir, n_max=n_max)
    else:
        # n_max = 5000
        n_max = 0
...
def load_syn(dataset_dir, split="train"):
    ...
    if split =="train":
       ...
       n_max = 0
    # n_max = 100 if split =="train" else 9000
    return read_image_list(data_dir, n_max=n_max)
...
def load_usps(dataset_dir, split="train"):
    ...
    # n_max = 100 if split == "train" else 1000
    n_max = 5000 if split =="train" else 0
    return read_image_list(data_dir, n_max=n_max)
